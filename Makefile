...
tailwind_output_css = $(configuration_frontend_dist)/css/output.css
yew_index_html = $(configuration_frontend_dist)/yew/index.html
...
target/debug/wg_display: $(dependencies) $(yew_build)
	cargo build
...
dependencies = \
	...
	src/configuration_frontend/Cargo.toml \
